...
const { validateRange, todayLocal } = require('../utils/validators');
...
const validateCreatePlanting = (data) => {
  ...
  return {
    ...
    location: { lat: location.lat, lng: location.lng },
      planted_at: planted_at || todayLocal(),
...
const validateSyncItem = (data) => {
  ...
  if (initial_survival_status !== undefined && initial_survival_status !== null) {
    if (!SURVIVAL_STATUS_VALUES.includes(initial_survival_status)) {
      errors.push({ field: 'initial_survival_status', message: 'El estado inicial debe ser: viva, estresada o muerta' });
    }
  }
  ...
  return {
    ...
    planted_at: planted_at || todayLocal(),
      ...
      initial_humidity: initial_humidity != null ? Number(initial_humidity) : null,
      initial_soil_texture: initial_soil_texture || null,
      initial_survival_status: initial_survival_status || null,
    },
  };
};

module.exports = { validateCreatePlanting, validateSyncItem };
